  ...
  return (
    <div className="p-6 border border-gray-100 rounded-lg bg-white shadow mt-5">
      ...
      <CommonModal isOpen={showModal} onClose={() => setShowModal(false)}>
        {selectedOrder && (
          <div className="p-4">
            <h2 className="font-bold text-lg mb-2">{selectedOrder.product}</h2>
            <div className="flex items-center gap-4 mb-4">
              <img
                src='https://extremegadgets.com.bd/wp-content/uploads/2024/03/hoco-esd15-wireless-bluetooth-headphones-2.jpg'
