...
import { topStudents } from "../../data/adminDashboardData";
import SectionTitle from "../SectionTitle/SectionTitle";

const AllTopPerformingStudents = () => {
  const [currentPage, setCurrentPage] = useState(1);

  const itemsPerPage = 10;
  const totalPages = Math.ceil(topStudents.length / itemsPerPage);
  const startIndex = (currentPage - 1) * itemsPerPage;
  const currentItems = topStudents.slice(startIndex, startIndex + itemsPerPage);
...
export default AllTopPerformingStudents;
