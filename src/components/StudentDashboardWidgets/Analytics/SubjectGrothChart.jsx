...
const subjects = [
  ...
  },
  {
    ...
    data: [
      ...
      { date: "Feb 09", value: 2 },
      { date: "Feb 16", value: 3 },
      { date: "Feb 23", value: 3.5 },
      { date: "Feb 30", value: 3.8 },
      { date: "Mar 06", value: 4 },
      { date: "Mar 13", value: 4.2 },
    ],
  },
  {
    name: "Math",
    ...
    data: [
      { date: "Feb 02", value: 2 },
      { date: "Feb 09", value: 2.2 },
      { date: "Feb 16", value: 3.2 },
      { date: "Feb 23", value: 3.5 },
      { date: "Feb 30", value: 4 },
      { date: "Mar 06", value: 4.5 },
      { date: "Mar 13", value: 4.8 },
    ],
  },
  {
    name: "Essay",
    ...
    data: [
      { date: "Feb 02", value: 1 },
      { date: "Feb 09", value: 1.5 },
      { date: "Feb 16", value: 2 },
      { date: "Feb 23", value: 2.2 },
      { date: "Feb 30", value: 2.8 },
      { date: "Mar 06", value: 3.5 },
      { date: "Mar 13", value: 4 },
    ],
  },
...
export default function SubjectGrowthChart() {
  ...
  return (
    <div className="p-6 rounded-2xl border border-base-300">
      ...
      <div className="p-4 border border-base-300  shadow rounded-xl">
